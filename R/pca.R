...
#'
#' For spatial modeling, principal components of distance matrices can serve as alternative spatial predictors to Moran's Eigenvector Maps (MEMs). Use [pca_multithreshold()] to compute PCA across multiple distance thresholds for multi-scale spatial modeling.
